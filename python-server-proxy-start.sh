...
# 启动新应用
docker run -d --env-file azure-openai-api-python-server-proxy/.env -p 8089:80 --name azure-openai-api-python-server-proxy azure-openai-api-python-server-proxy
